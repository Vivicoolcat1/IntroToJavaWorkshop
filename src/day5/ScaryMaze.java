...
int background = -1; 
		...
		//10. if the mouse is on the end color
				if(mouseColor==-12591601){
					JOptionPane.showMessageDialog(null,"YOU WON!!!! YOU ARE THE MASTER OF THE GAME OF LIFE AND POKEMON GO, STAY DETERMINATED");
				}
